...
//   return (
//     <div className="h-screen flex flex-col lg:flex-row bg-slate-100 overflow-hidden max-lg:min-h-screen">
//       <main className="flex-1 flex flex-col min-w-0">
...
export default function SalesAssistantPage() {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col lg:flex-row bg-slate-100 overflow-hidden">
      ...
      <aside className="w-full h-[45dvh] lg:h-full lg:w-[400px] bg-white border-t lg:border-t-0 lg:border-l border-slate-200 flex flex-col shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.1)] lg:shadow-xl z-10 shrink-0">
        <div className="p-4 lg:p-6 border-b border-slate-200 bg-slate-50 flex items-center gap-2 lg:gap-3 shrink-0">
          <ShoppingCart className="text-slate-700 w-5 h-5 lg:w-6 lg:h-6" />
          <h2 className="text-lg lg:text-xl font-bold text-slate-900">
            Current Order
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col items-center text-center p-6 lg:p-8">
            ...
            <button
              onClick={resetTerminal}
              className="w-full bg-slate-900 text-white font-bold text-base lg:text-lg py-3 lg:py-4 rounded-xl hover:bg-slate-800 active:scale-[0.98] transition-all shadow-md"
            >
              New Sale
            </button>
          </div>
